...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--which_model_netG', type=str, default='my_resnet_9block', help='selects model to use for netG')
		...
		self.parser.add_argument('--phase', type=str, default='finetune', help='train, test, finetune,etc')
